                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <i class="fa fa-question-circle"></i> <?php echo display('returning_customer') ?><a
                                            ...
                                            href="#collapseOne">
                                        <b><?php echo display('click_here_to_login') ?> </b></a>
                                </h4>
                            </div>
                        ...
                        <div class="row">
                                    ...
                                    <select name="country" id="country" class="form-control" required>
                                        ...
                                        if ($selected_country_info) {
                                            foreach ($selected_country_info as $country) {
                                                ?>
                                                <option value="<?php echo html_escape($country->id) ?>" <?php if ($this->session->userdata('country') == $country->id) {
                                                    echo "selected";
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="color5 padfont" ><?php echo display('add_country_code') ?></span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ship_country" id="ship_country" class="form-control">
                                            ...
                                            if ($selected_country_info) {
                                                foreach ($selected_country_info as $country) {
                                                    ?>
                                                    <option value="<?php echo html_escape($country->id) ?>" <?php if
                ...
                <div class="col-sm-4">
                    <div class="check-orde">
                        ...
                        <div class="payment-block" id="payment">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="payment_method" value="1" checked required>
