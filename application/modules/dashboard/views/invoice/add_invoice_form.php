                    ...
                    <table class="table table-bordered table-hover" id="normalinvoice">
                            ...
                            <td class="text-right" colspan="2">
                                ...
                                <select name="shipping_method" id="shipping_method" class="form-control">
                                    ...
                                    <?php foreach ($shipping_methods as $shipping_method): ?>
                                            <option value="<?php echo html_escape($shipping_method['method_id']); ?>" data-amount="<?php echo html_escape($shipping_method['charge_amount']); ?>"><?php echo html_escape($shipping_method['method_name']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            <td align="center" class="width_220">
                                ...
                                <input type="submit" id="add-invoice_btn" class="btn btn-success" name="add-invoice"
