                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" tabindex="3" class="form-control datepicker"
                               name="invoice_date" value="<?php echo html_escape($date) ?>" id="date" required/>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="discount[]"
                                       ...
                                       placeholder="Discount" value="<?php echo html_escape($value['discount']) ?>"
                                       min="0"/>
                            </td>
                            <td>
                                <input class="total_price form-control text-right" type="text"
                                       name="total_price[]" id="total_price_<?php echo $i ?>"
                                       value="<?php echo html_escape($value['total_price']) ?>" readonly="readonly"/>
                            ...
                            <td>
                                ...
                                <?php if ($tax['cgst_status'] == 1) { ?>
                                    ...
                                    <input type="hidden" id="total_cgst_<?php echo $i ?>"
                                           class="total_cgst" name="cgst[]" value="<?php echo  $cgst ?>"/>
                                ...
                                if ($tax['sgst_status'] == 1) { ?>
                                    ...
                                    <input type="hidden" id="total_sgst_<?php echo $i ?>"
                                           class="total_sgst" name="sgst[]" value="<?php echo  $sgst ?>"/>
                                ...
                                if ($tax['igst_status'] == 1) { ?>
                                    ...
                                    <input type="hidden" id="total_igst_<?php echo $i ?>"
                                           class="total_igst" name="igst[]" value="<?php echo  $igst ?>"/>
                ...
                <tr>
                    ...
                    <td colspan="5" rowspan="4">
                        ...
                        <textarea class="form-control" name="invoice_details" id="invoice_details"
                                  rows="6" placeholder="<?php echo display('invoice_details') ?>"><?php echo html_escape($invoice_details) ?></textarea>
                    </td>
                    ...
                    <td class="text-right">
                        <input type="text" id="total_discount_ammount" class="form-control text-right"
                               name="total_discount" readonly="readonly" value="<?php echo html_escape($total_discount) ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="text-right" colspan="2">
                ...
                <tr>
                    <td class="text-right" colspan="2">
                        ...
                        <select name="shipping_method" id="shipping_method" class="form-control">
                            ...
                            foreach ($shipping_methods as $shipping_method):
                                ?>
                                <option <?php echo ($shipping_method['method_id'] == $shipping_method_id)? "selected" : ""?> data-amount="<?php echo html_escape($shipping_method['charge_amount'])?>"  value="<?php echo html_escape($shipping_method['method_id']); ?>"><?php echo html_escape($shipping_method['method_name']); ?></option>
                            <?php  endforeach; ?>
                        </select>
                    </td>
                    ...
                    <td class="text-right">
                        <input type="text" id="shipping_charge" class="form-control text-right"
                               name="shipping_charge" value="<?php echo html_escape($shipping_charge); ?>" onkeyup="calculateSum();" placeholder="0.00"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <input type="text" id="grandTotal" class="form-control text-right"
                               name="grand_total_price" value="<?php echo html_escape($total_amount) ?>" readonly="readonly"/>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        ...
                        <input type="hidden" name="invoice_id" id="invoice_id" value="<?php echo html_escape($invoice_id); ?>"/>
                        <input type="hidden" name="invoice" id="invoice" value="<?php echo html_escape($invoice) ?>"/>
                    ...
                    <td class="text-right">
                        <input type="text" id="paidAmount"
                               ...
                               name="paid_amount" value="<?php echo html_escape($paid_amount) ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-right">
                        <input type="text" id="dueAmmount" class="form-control text-right"
                               name="due_amount" value="<?php echo html_escape($due_amount); ?>" readonly="readonly"/>
                    </td>
                </tr>
