...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('add_about_us') ?></h1>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('add_about_us') ?> </h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('dashboard/Cabout_us/insert_about_us', array('class' => 'form-vertical','id' => 'validate'))?>
                    <div class="panel-body">

                        <div class="form-group row">
                            <label for="favicon" class="col-sm-2 col-form-label"><?php echo display('favicon')?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="favicon" id="favicon" type="text" required="" placeholder="<?php echo display('favicon')?>">
                            </div>
                        </div>   
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-about_us" class="btn btn-success btn-large" name="add-about_us" value="<?php echo display('save') ?>" />
                                <input type="submit" id="add-about_us-another" class="btn btn-primary btn-large" name="add-about_us-another" value="<?php echo display('save_and_add_another') ?>" />
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
