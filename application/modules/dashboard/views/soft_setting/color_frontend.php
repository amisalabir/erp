        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('dashboard/Csoft_setting/update_frontend_color', array('class' => 'form-vertical','id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="color5" value="{color5}" id="color5" type="color">
                                 <small><?php echo display('fe_color5')?></small>
                            </div>
                        </div>
